...
3) Блок "3 ключевых кейса":
   ...
   - обязательно цифры: какие-либо метрики, проценты, цифры, которые есть в резюме и которые будут релевантны для вакансии. Очень важно используй только ту информацию, которая есть в резюме

Не используй в тексте название самой вакансии или название компании.
Не используй Markdown, вообще никакого
Пиши только plain-text. Запрещены символы *, #, _, списки и форматирование
