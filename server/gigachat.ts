...
8) Используй актуальный опыт из резюме за последние 2 года, не бери данные за очень старый период (более 3 лет назад)
9) Не используй в письме точное название профессии/специалиста из резюме
